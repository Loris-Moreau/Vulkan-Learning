...
MatMN Constraint::GetInverseMassMatrix () const
{
    ...
    invMassMatrix.Zero();
    invMassMatrix.rows[0][0] = m_bodyA->inverseMass;
    invMassMatrix.rows[1][1] = m_bodyA->inverseMass;
    invMassMatrix.rows[2][2] = m_bodyA->inverseMass;
    ...
    invMassMatrix.rows[6][6] = m_bodyB->inverseMass ;
    invMassMatrix.rows[7][7] = m_bodyB->inverseMass ;
    invMassMatrix.rows[8][8] = m_bodyB->inverseMass ;
...
VecN Constraint::GetVelocities() const
{
    ...
    q_dt[0] = m_bodyA->linearVelocity.x;
    q_dt[1] = m_bodyA->linearVelocity.y;
    q_dt[2] = m_bodyA->linearVelocity.z;
    q_dt[3] = m_bodyA->angularVelocity.x;
    q_dt[4] = m_bodyA->angularVelocity.y;
    q_dt[5] = m_bodyA->angularVelocity.z;
    q_dt[6] = m_bodyB->linearVelocity.x;
    q_dt[7] = m_bodyB->linearVelocity.y;
    q_dt[8] = m_bodyB->linearVelocity.z;
    q_dt[9] = m_bodyB->angularVelocity.x;
    q_dt[1] = m_bodyB->angularVelocity.y;
    q_dt[1] = m_bodyB->angularVelocity.z;
